...
XTrain_l1 = np.loadtxt('D:\Postdoc\Paper 8\FRC_data\Twin data-2\XTrain-l1.csv', delimiter=',')
XTrain_l2 = np.loadtxt('D:\Postdoc\Paper 8\FRC_data\Twin data-2\XTrain-l2.csv', delimiter=',')
XTrain_h1 = np.loadtxt('D:\Postdoc\Paper 8\FRC_data\Twin data-2\XTrain-h1.csv', delimiter=',')
XTrain_h2 = np.loadtxt('D:\Postdoc\Paper 8\FRC_data\Twin data-2\XTrain-h2.csv', delimiter=',')
YTrain_label = np.loadtxt('D:\Postdoc\Paper 8\FRC_data\Twin data-2\label.csv', delimiter=',')
XTest_l = np.loadtxt('D:\Postdoc\Paper 8\FRC_data\Twin data-2\XTest-l.csv', delimiter=',')
XTest_h = np.loadtxt('D:\Postdoc\Paper 8\FRC_data\Twin data-2\XTest-h.csv', delimiter=',')
YTrain = np.loadtxt('D:\Postdoc\Paper 8\FRC_data\Twin data-2\YTrain.csv', delimiter=',')
YTest = np.loadtxt('D:\Postdoc\Paper 8\FRC_data\Twin data-2\YTest.csv', delimiter=',')
XTrain_l = np.loadtxt('D:\Postdoc\Paper 8\FRC_data\Twin data-2\XTrain-l.csv', delimiter=',')
XTrain_h = np.loadtxt('D:\Postdoc\Paper 8\FRC_data\Twin data-2\XTrain-h.csv', delimiter=',')
YTrain1 = np.loadtxt('D:\Postdoc\Paper 8\FRC_data\Twin data-2\YTrain1.csv', delimiter=',')
YTrain2 = np.loadtxt('D:\Postdoc\Paper 8\FRC_data\Twin data-2\YTrain2.csv', delimiter=',')
...
class TSR_Net(nn.Module):
    def __init__(self):
        ...
        self.model2 = nn.Sequential(
            ...
            nn.Linear(in_features=128, out_features=386, bias=True),
        )
...
np.savetxt('D:\Postdoc\Paper 8\FRC_data\Reconstructed LIBS/reconstructed-test.csv', Pred_test, fmt='%.4f', delimiter=',')
np.savetxt('D:\Postdoc\Paper 8\FRC_data\Reconstructed LIBS/reconstructed-train.csv', Pred_train, fmt='%.4f', delimiter=',')
np.savetxt('D:\Postdoc\Paper 8\FRC_data\Epochs vs loss-2/sample.csv', train_loss_dict, fmt='%.4f', delimiter=',')

m1, n1 = YTest.shape
cls1 = torch.max(cls1, 1)[1].data.numpy()

np.savetxt('D:\Postdoc\Paper 8\FRC_data\Epochs vs loss-2/Yp.csv', cls1, fmt='%.4f', delimiter=',')
